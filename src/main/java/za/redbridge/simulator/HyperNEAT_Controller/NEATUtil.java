...
//import za.redbridge.controller.NEAT.training.species.NEATSpeciation;
...
public final class NEATUtil {
    ...
    public static NoveltyTrainEA constructNoveltyTrainer(NEATPopulation population,
            CalculateScore calculateScore) {
        NoveltyTrainEA result = new NoveltyTrainEA(population, calculateScore);
        result.setSpeciation(new OriginalNEATSpeciation());
    ...
    public static ObjectiveTrainEA constructObjectiveTrainer(NEATPopulation population,
            CalculateScore calculateScore) {
        ObjectiveTrainEA result = new ObjectiveTrainEA(population, calculateScore);
        result.setSpeciation(new OriginalNEATSpeciation());
